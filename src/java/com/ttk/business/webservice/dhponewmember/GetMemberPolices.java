...
@XmlRootElement(name = "GetMemberPolices")
public class GetMemberPolices {
    ...
    @XmlElementRef(name = "searchValue", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
