...
@XmlRootElement(name = "UploadMemberRegister")
public class UploadMemberRegister {
    ...
    @XmlElementRef(name = "fileContent", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
