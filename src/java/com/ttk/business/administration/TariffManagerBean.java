...
public class TariffManagerBean implements TariffManager {
    ...
    public String uploadTariffEmpanelment(InputStream inputStream2) throws TTKException{
        tariffPlanDAO = (TariffPlanDAOImpl)this.getAdministrationDAO("tariffplan");
        return tariffPlanDAO.uploadTariffEmpanelment(inputStream2);
    ...
    public TariffUploadVO getTariffDetail(long TariffSeqId,Long HospSeqId,String tariffType,long addedBy) throws TTKException{
    	tariffPlanDAO = (TariffPlanDAOImpl)this.getAdministrationDAO("tariffplan");
        return tariffPlanDAO.getTariffDetail(TariffSeqId,HospSeqId, tariffType,addedBy);
    }//end of getTariffSearchList(ArrayList alSearchObjects,String strIdentifier)
...
public long editTariffItem(TariffUploadVO tariffUploadVO,long addedBy) throws TTKException {
	...
	public int updateServiceTypesByNetworks(String tarifFlag,StringBuffer strService, String networkType, Long userSeqId,String providerCode,String payerCode,String corpCode) throws TTKException {
	 ...
	 public ArrayList getProTariffList(Long hospitalSeqId)
				throws TTKException {
		 tariffPlanDAO = (TariffPlanDAOImpl)this.getAdministrationDAO("tariffplan");
		 return tariffPlanDAO.getProTariffList(hospitalSeqId);
		}
	 
	  public ArrayList getProviderTariffReport(String networkType,Long hospitalSeqId) throws TTKException
	    {
		  tariffPlanDAO = (TariffPlanDAOImpl)this.getAdministrationDAO("tariffplan");
		  	return tariffPlanDAO.getProviderTariffReport(networkType,hospitalSeqId);
	    }
	
	  
	  public ArrayList getSelectedProviderTariffReport(ArrayList<String> alselected, String networkType,Long hospitalSeqId) throws TTKException{

		  tariffPlanDAO = (TariffPlanDAOImpl)this.getAdministrationDAO("tariffplan");
		  	return tariffPlanDAO.getSelectedProviderTariffReport(alselected,networkType,hospitalSeqId);
	  ...
	  {  
		  tariffPlanDAO = (TariffPlanDAOImpl)this.getAdministrationDAO("tariffplan");
	        return tariffPlanDAO.doViewTariffUploadTemplateErrorLog(startDate,endDate);
	  }
	  
		public String getAllNetworkdata() throws TTKException
		{
			  tariffPlanDAO = (TariffPlanDAOImpl)this.getAdministrationDAO("tariffplan");
		        return tariffPlanDAO.getAllNetworkdata();
