...
public interface MemberManager {
   ...
   /**
	...
	public Reader getMemberUploadXML(ArrayList<String> allData) throws TTKException;
     /**
      * this method returns  XML type data which contains the Active Members to be Uploaded for DHPO
      * @param insCode the insurance Company Code
      * @Exception throws TTKException 
      */
	...
	public ArrayList<Object> getReciverMailList(ArrayList<Object> searchData) throws TTKException;
	
	public Long saveReciverMailData(ReciverMailIdVO reciverMailIdVO) throws TTKException;
	
	public ReciverMailIdVO getReciverMailData(Long insurenceSeqID) throws TTKException;
	
	public ArrayList<Object> getAllReciverMailList() throws TTKException;

	public int deleteReciverMailList(Long l) throws TTKException;
