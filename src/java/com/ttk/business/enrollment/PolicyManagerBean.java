...
public class PolicyManagerBean implements PolicyManager{
	...
	@Override
	public int deleteUploadedFile(String policy_seq_id,String moudocseqid, String deleteRemarks, Long userSeqId,String mode) throws TTKException {
		// TODO Auto-generated method stub
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
		return policyDAO.deleteUploadedFile(policy_seq_id,moudocseqid,deleteRemarks,userSeqId,mode);
	}

	public ArrayList<Object> getPreviousCategoryRemarks(String previous_policy_no,long lnginsuranceSeqID) throws TTKException
	{
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
		return policyDAO.getPreviousCategoryRemarks(previous_policy_no,lnginsuranceSeqID);
	}
	...
	public ArrayList<String[]> saveBulkPolicyDetails(ArrayList<String[]> excelData,ArrayList<String> batchDtl) throws TTKException{
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
		return policyDAO.saveBulkPolicyDetails(excelData,batchDtl);
	}
	...
	{
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
	        return policyDAO.addCoInsComp(compName,policyDetailVO,policySqId);
	...
	{
		policyDAO = (PolicyDAOImpl) this.getEnrollmentDAO("enrollment");
	        return policyDAO.getCompanyCode(compSeqId);
	 
	}
	public long savePolicy2(PolicyDetailVO policyDetailVO,long iUpdate) throws TTKException {
		policyDAO = (PolicyDAOImpl)this.getEnrollmentDAO("enrollment");
		return policyDAO.savePolicy2(policyDetailVO,iUpdate);
	}
