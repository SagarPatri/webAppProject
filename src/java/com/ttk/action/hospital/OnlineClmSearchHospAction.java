    ...
    public ActionForward doDashBoardData(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			...
			if("CLM".equals(preAuthClm)){
			 docClaims=(Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),sFromDate,sToDate,"Claims");
			 ...
			 docPreauth=(Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),sFromDate,sToDate,"Preauth");
