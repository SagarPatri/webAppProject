...
public class HospitalContactAction extends TTKAction
{
    ...
    private static final String strPartnercontactlist="partnercontactlist";
    ...
    public ActionForward doDefault(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
            ...
            {
                //create the required grid table
                tableData.createTableInfo("InsuranceContactTable1",new ArrayList());
            }// end of else
    ...
    public ActionForward doSwitchTo(ActionMapping mapping,ActionForm form,HttpServletRequest request,
        ...
        try
        {
            ...
            {
                frmSearchContact.set("caption","Professional Contacts");
    ...
    public ActionForward doSearch(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
            ...
            {
            	 lngHospitalSeqId= new Long(TTKCommon.getWebBoardId(request));
            }//end of else if(strSubLink.equals("Partner"))
    ...
    public ActionForward doChangeWebBoard(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
            ...
            {
                //create the required grid table
            	Long hospSeqId = TTKCommon.getWebBoardId(request);
                tableData.createTableInfo("HospitalContactTable",new ArrayList());
            }// end of if(strSubLink.equals("Hospital"))
*/            
            ...
            {   ContactManager contactObject=this.getContactManagerObject();
                 ...
                 else
                 {
                     ...
                     tableData.setSearchData(this.populateSearchCriteria((DynaActionForm)form,request,
                     		lngHospitalSeqId,null,null,null));
                     tableData.modifySearchData("search");
                 }//end of else
                 ArrayList alContact= contactObject.getContactList(tableData.getSearchData());
                 DynaActionForm frmSearchContact=(DynaActionForm)form;  //get the DynaActionForm instance
    ...
    public ActionForward doActivateInactivate(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try{
           ...
           // System.out.println("alContact::"+alContact+"--tableData::"+tableData);
    ...
    private String getForwardPath(HttpServletRequest request) throws TTKException{
    	...
    	try{
    		...
    		if(strSubLink.equals("Partner")){
    			strContactPath=strPartnercontactlist;
    ...
    private ArrayList<Object> populateSearchCriteria(DynaActionForm searchContactForm,HttpServletRequest request, Long lHospitalSeqId, Long lInsuranceSeqID, Long lGroupRegSeqId, Long lBankSeqId) throws TTKException
    {
        ...
        else if(strSubLink.equals("Broker"))
        {
            ...
            //AK
            alSearchParams.add(new SearchCriteria("D.ROLE_SEQ_ID",(String)searchContactForm.get("userRoleBRO"),"equals"));
            alSearchParams.add(new SearchCriteria("C.USER_ID",(String)searchContactForm.get("userID"),"equals"));
        }//end of else if(strSubLink=="Insurance")
      ...
      // end added for broker login kocb
        ...
        if(searchContactForm.get("userStatus").equals("ACT"))
        {
        	if("Broker".equals(strSubLink)){
        		alSearchParams.add(new SearchCriteria("A.ACTIVE_YN","Y","equals"));
        	}else{
            alSearchParams.add(new SearchCriteria("ACTIVE_YN","Y","equals"));
        	}
        }//end of if(searchContactForm.get("userStatus").equals("ACT"))        
        ...
        {
        	if("Broker".equals(strSubLink)){
        		alSearchParams.add(new SearchCriteria("A.ACTIVE_YN","N","equals"));
        	}else{
            alSearchParams.add(new SearchCriteria("ACTIVE_YN","N","equals"));
        	}
        }//end of else
        ...
        else if("Broker".equals(strSubLink)){
        	alSearchParams.add(new SearchCriteria("A.PROVIDE_ACCESS_USER_YN", (String)searchContactForm.get("applUser1"),"equals"));
        }
        else
        {
        	alSearchParams.add(new SearchCriteria("PROVIDE_ACCESS_USER_YN", (String)searchContactForm.get("applUser1"),"equals"));
    ...
    public ActionForward doDownloadProviderContact(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws TTKException
	{
		try{
			 log.debug("Inside the doDownloadProviderContact method of HospitalContactAction");
			 setLinks(request);
			 try
			 { 
				 ContactManager contactObject=this.getContactManagerObject();
	    		...
	    		/* Long  hospitalSeqId =Long.parseLong(hospSeqId);*/
				 alData	= contactObject.getProviderProfessionalContact(hospSeqId,downloadtype);
			
				 if(downloadtype.equals("gencontact"))
				 {
				 ...
				 if(alData.size()!=0)
	              ...
	              request.setAttribute("flag", "empanelmentgeneralcontact");
				  }
				
				 }
				 else if(downloadtype.equals("professionalcontact"))
				 {
					 ...
					 if(alData.size()!=0)
		              ...
		              request.setAttribute("alData", alData);
		              request.setAttribute("flag", "empanelmentprofessionalcontact");
					  }
