 ...
 * 
 */
public class BrokerUserAssociatedTable extends Table
{
    /**
    ...
    public void setTableProperties()
    {
     ...
     //   colName.setIsLink(true);
      ...
      //Setting properties for contact EMAIL
        ...
        colPrimaryEmailID.setColumnWidth("15%");
      ...
      //Setting properties for contact Status
        ...
        Column colAssociateDissAssociate  = new Column("Associated");
        ...
        colAssociateDissAssociate.setHeaderLinkTitle("Sort by Associated");
