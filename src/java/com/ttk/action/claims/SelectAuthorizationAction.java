...
public class SelectAuthorizationAction extends TTKAction {
	...
	public ActionForward doSearch(ActionMapping mapping,ActionForm form,HttpServletRequest request,
		...
		try{
			...
			else
			{
				...
				tableData.setSearchData(this.populateSearchCriteria(frmSelectAuth,request,memberSeqID));
	 ...
	 */
	private ArrayList<Object> populateSearchCriteria(DynaActionForm frmSelectAuth,HttpServletRequest request,String memberSeqID)throws TTKException
	{
