...
//    			commManagerObject.sendFax(strCommArray[2]);    			
    ...
    public ActionForward doViewBalanceSI(ActionMapping mapping,ActionForm form,HttpServletRequest request,
    	...
    	try
    	{
    		...
    		// System.out.println("authorizationVO.getMemberSeqID():"+authorizationVO.getMemberSeqID());
    		// System.out.println(balCopayDeducVO.getBdApprovedAmt());
    		//System.out.println(balCopayDeducVO.getBdMaxCopayAmt());
    		}
    		else{
