...
*/
		...
		String strRootImagelist[]={"DependentsIcon","DomiciliaryIcon","PolicyIcon","CardIcon","RatesIcon","AddIcon","CancelledIcon","ChangePlanIcon","AuditLogsIcon","DeleteIcon"};	//"ChangePlanIcon" added for koc 1278 and 1270
        String strNodeImagelist[]={"BenefitsIcon","PedIcon","PolicyIcon","CardIcon","","EditIcon","CancelledIcon","AuditLogsIcon","DeleteIcon"};
		String strRootImageTitle[]={"Renew Members","Domiciliary Treatment(OPD) / Hospitalization Limits/ High Deductable","Family Rules","Approve for Card Printing","Premium Details","Add New Dependant","Cancel Enrollment","Change Plan / Hospital Cash Benefit / Canvalescence Cash Benefit / Personal Waiting Period","AuditLogsTrail","Delete Enrollment"};	//Personal waiting period added for koc 1278 and 1270
		String strNodeImageTitle[]={"Benefit limit and Subbenefit limit Utilization","Pre Existing Desease","Member Rules","Approve for Card Printing","","Edit Dependant Details","Cancel Dependant","AuditLogsTrail","Delete Dependant"};
