	        ...
	        if(document!=null){
	       	...
	       	out.print("<legend>Claim Details</legend>");
	       			if(pNode!=null){ 
	       			    ...
	       			    out.print("</tr>");
	       			    out.print("<tr>");
	       			    out.print("<td class='formLabel' width='25%'>Settelment No.:</td>");
	       			 ...
	       			 out.print("<tr>");
	       			    ...
	       			    out.print("<td class='formLabel' width='25%'>Remittance Advice File Name:</td>");
	       			    out.print("<td class='textLabelBold' width='25%'>"+pNode.valueOf("@ra_file_name ")+"</td>");		   
	       			    out.print("</tr>");
	       			 out.print("</table>");			 
	       			  } //	if(pNode!=null){ 
	       	out.print("</fieldset>");
