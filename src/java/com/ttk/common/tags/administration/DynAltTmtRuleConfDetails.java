...
public class DynAltTmtRuleConfDetails extends TagSupport{
	...
	public int doStartTag() throws JspException
	{
		try
		{
			...
			ArrayList<InvestigationRuleVO> alInvestRules=(ArrayList<InvestigationRuleVO>)session.getAttribute("AltTmtRuleDetails");
			...
			out.print("<td align='center' style='width:5%;' class='gridHeader'><table><tr><th>Limit Per Policy</th></tr><tr><th>AED</th></tr></table></td>");
			out.print("<td align='center' style='width:5%;' class='gridHeader'><table><tr><th>No of Sessions</th></tr><tr><th>Allowed</th></tr></table></td>");
			out.print("<td align='center' style='width:5%;' class='gridHeader'><table><tr><th>Limit Per</th></tr><tr><th>sessions(AED)</th></tr></table></td>");
		...
		if(alInvestRules!=null){
	        	for(InvestigationRuleVO investigationRuleVO:alInvestRules){
	        		   ...
	        		   Node fieldNode=investigationRuleVO.getStaticDoc().selectSingleNode("/Alternate-Treatments/Fields");
	                String strPreAppYN=("Y".equals(fieldNode.valueOf("@pre-appr-yn"))?"YES":"NO");
	                
	        		 out.print("<td style='width:2%;' align='center'>"+(row+1)+"&nbsp;<a href=\"#\" onclick=\"editAltTmtConf('"+row+"');\">Edit</a></td>");
	                 ...
	                 out.print("<td style='width:5%;' align='center'>"+fieldNode.valueOf("@limit-per-policy")+"</td>");
	                 out.print("<td style='width:5%;' align='center'>"+fieldNode.valueOf("@no-of-sessions-allowed")+"</td>");
	                
	                 out.print("<td style='width:5%;' align='center'>"+fieldNode.valueOf("@limit-per-session")+"</td>");
	               
	                 out.print("<td style='width:5%;' align='center'><a href=\"#\" onclick=\"viewAltTmtStaticConfDtls('"+row+"','CPD');\">View</a></td>");
	                 ...
	                 out.print("<td style='width:3%;' align='center'><a href=\"#\" onclick=\"deleteAltTmtDtls('"+row+"');\">"+delImage+"</a></td>");
	                 row++; 
	        	}
