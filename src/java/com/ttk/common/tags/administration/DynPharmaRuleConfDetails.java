...
public class DynPharmaRuleConfDetails extends TagSupport
{
	/**CountryCopayDetails
	...
	*/
	...
	public int doStartTag() throws JspException
	{
		try
		{
			...
			String delImage="<img src='/ttk/images/DeleteIcon.gif' alt='Delete Pharmaceutical Details' width='12' height='12' border='0'>";
			ArrayList<InvestigationRuleVO> alInvestRules=(ArrayList<InvestigationRuleVO>)session.getAttribute("PharmaceuticalRuleDetails");
			...
			out.print("<td align='center' style='width:15%;' class='gridHeader'><table><tr><th>Per-Claim</th></tr><tr><th>Limit</th></tr></table></td>");
			out.print("<td align='center' style='width:15%;' class='gridHeader'><table><tr><th>Per-Policy</th></tr><tr><th>Limit</th></tr></table></td>");
			
			out.print("<td align='center' style='width:10%;' class='gridHeader'>Copay/Deductible</td>");
			out.print("<td align='center' style='width:15%;' class='gridHeader'>");
		...
		if(alInvestRules!=null){
	        	for(InvestigationRuleVO investigationRuleVO:alInvestRules){
	        		   ...
	        		   Node fieldNode=investigationRuleVO.getStaticDoc().selectSingleNode("/Pharmaceutical/Fields");
	                String strPreAppYN=("Y".equals(fieldNode.valueOf("@pre-appr-yn"))?"YES":"NO");
	                
	        		 out.print("<td style='width:2%;' align='center'>"+(row+1)+"&nbsp;<a href=\"#\" onclick=\"editPharmaConf('"+row+"');\">Edit</a></td>");
	        		 ...
	        		 out.print("<td style='width:15%;' align='center'>"+fieldNode.valueOf("@per-claim-limit")+"</td>");
	                 out.print("<td style='width:15%;' align='center'>"+fieldNode.valueOf("@per-policy-limit")+"</td>");
	                 out.print("<td style='width:10%;' align='center'><a href=\"#\" onclick=\"viewPharmaStaticConfDtls('"+row+"','CPD');\">View</a></td>");
	                 
	                 out.print("<td style='width:15%;' align='center'>"+fieldNode.valueOf("@per-clm-cd-limit")+"</td>");
	                 out.print("<td style='width:15%;' align='center'>"+fieldNode.valueOf("@per-plcy-cd-limit")+"</td>");
	                 out.print("<td style='width:3%;' align='center'><a href=\"#\" onclick=\"deletePharmaDtls('"+row+"');\">"+delImage+"</a></td>");
	                 row++; 
	        	}
...
}//end of DynPharmaRuleConfDetails class 
