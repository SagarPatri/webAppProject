...
public class DynGyncolgyRuleConfDetails extends TagSupport{
	...
	public int doStartTag() throws JspException
	{
		try
		{
			...
			ArrayList<InvestigationRuleVO> alInvestRules=(ArrayList<InvestigationRuleVO>)session.getAttribute("GyncolgyRuleDetails");
		...
		if(alInvestRules!=null){
	        	for(InvestigationRuleVO investigationRuleVO:alInvestRules){
	        		   ...
	        		   Node fieldNode=investigationRuleVO.getStaticDoc().selectSingleNode("/Gynaecology/Fields");
	                String strPreAppYN=("Y".equals(fieldNode.valueOf("@pre-appr-yn"))?"YES":"NO");
	                
	        		 out.print("<td style='width:2%;' align='center'>"+(row+1)+"&nbsp;<a href=\"#\" onclick=\"editGyncolgyConf('"+row+"');\">Edit</a></td>");
	                 ...
	                 out.print("<td style='width:5%;' align='center'><a href=\"#\" onclick=\"viewGyncolgyStaticConfDtls('"+row+"','CPD');\">View</a></td>");
	                 ...
	                 out.print("<td style='width:3%;' align='center'><a href=\"#\" onclick=\"deleteGyncolgyDtls('"+row+"');\">"+delImage+"</a></td>");
	                 row++; 
	        	}
