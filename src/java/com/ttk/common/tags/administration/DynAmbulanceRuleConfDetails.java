...
public class DynAmbulanceRuleConfDetails extends TagSupport
{
	/**CountryCopayDetails
	...
	*/
	...
	public int doStartTag() throws JspException
	{
		try
		{
			...
			ArrayList<InvestigationRuleVO> alInvestRules=(ArrayList<InvestigationRuleVO>)session.getAttribute("AmbulanceRuleDetails");
		...
		if(alInvestRules!=null){
	        	for(InvestigationRuleVO investigationRuleVO:alInvestRules){
	        		   ...
	        		   Node fieldNode=investigationRuleVO.getStaticDoc().selectSingleNode("/Ambulance/Fields");
	                String strPreAppYN=("Y".equals(fieldNode.valueOf("@pre-appr-yn"))?"YES":"NO");
	                
	        		 out.print("<td style='width:2%;' align='center'>"+(row+1)+"&nbsp;<a href=\"#\" onclick=\"editAmbulanceConf('"+row+"');\">Edit</a></td>");
                    ...
                    String strEmirateHiddenBox="<input type=\"hidden\" id=\"emiratesID"+row+"\" value=\""+investigationRuleVO.getEmiratesIDs()+"\">";
	                 ...
	                 out.print("<td style='width:5%;' align='center'><a href=\"#\" onclick=\"viewAmbulanceStaticConfDtls('"+row+"','CPD');\">View</a></td>");
	                 ...
	                 out.print("<td style='width:3%;' align='center'><a href=\"#\" onclick=\"deleteAmbulanceDtls('"+row+"');\">"+delImage+"</a></td>");
	                 row++; 
	        	}
