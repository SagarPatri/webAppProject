/**
 * @ (#) DynVaccinRuleConfDetails.java May 11, 2018
 * Project : ProjectX
 * File : DynVaccinRuleConfDetails.java
 * Author : Hare Govind
 * Company :Vidal
...
public class DynVaccinRuleConfDetails extends TagSupport{
	...
	*/
	...
	public int doStartTag() throws JspException
	{
		try
		{
			...
			ArrayList<InvestigationRuleVO> alInvestRules=(ArrayList<InvestigationRuleVO>)session.getAttribute("VaccinationsRuleDetails");
			...
			out.print("<td align='center' style='width:5%;' class='gridHeader'>Min Age</td>");
			out.print("<td align='center' style='width:5%;' class='gridHeader'>Max Age</td>");
		...
		if(alInvestRules!=null){
	        	for(InvestigationRuleVO investigationRuleVO:alInvestRules){
	        		   ...
	        		   Node fieldNode=investigationRuleVO.getStaticDoc().selectSingleNode("/Vaccinations/Fields");
	                String strPreAppYN=("Y".equals(fieldNode.valueOf("@pre-appr-yn"))?"YES":"NO");
	                
	        		 out.print("<td style='width:2%;' align='center'>"+(row+1)+"&nbsp;<a href=\"#\" onclick=\"editVaccinConf('"+row+"');\">Edit</a></td>");
	                 ...
	                 out.print("<td style='width:5%;' align='center'><a href=\"#\" onclick=\"viewVaccinStaticConfDtls('"+row+"','CPD');\">View</a></td>");
	                 ...
	                 out.print("<td style='width:10%;' align='center'>"+fieldNode.valueOf("@min-age")+"</td>");
	                 out.print("<td style='width:10%;' align='center'>"+fieldNode.valueOf("@max-age")+"</td>");
	                 
	                 out.print("<td style='width:3%;' align='center'><a href=\"#\" onclick=\"deleteVaccinDtls('"+row+"');\">"+delImage+"</a></td>");
	                 row++; 
	        	}
...
} //end of DynVaccinRuleConfDetails class 
