...
public class DynConsultRuleConfDetails extends TagSupport
{
	/**CountryCopayDetails
	...
	*/
	...
	public int doStartTag() throws JspException
	{
		try
		{
			...
			ArrayList<InvestigationRuleVO> alInvestRules=(ArrayList<InvestigationRuleVO>)session.getAttribute("ConsulationRuleDetails");
			...
			out.print("<td align='center' style='width:5%;' class='gridHeader'><table><tr><th>Encounter</th></tr><tr><th>Types</th></tr></table></td>");
			...
			out.print("<td align='center' style='width:5%;' class='gridHeader'><table><tr><th>Follow-Up</th></tr><tr><th>Period</th></tr></table></td>");
			...
			out.print("<table><tr><th>Clinician Consultation</th></tr><tr><th>Type Copay/Deductable</th></tr></table></td>");
			out.print("<td align='center' style='width:10%;' class='gridHeader'>");
		...
		if(alInvestRules!=null){
	        	for(InvestigationRuleVO investigationRuleVO:alInvestRules){
	        		   ...
	        		   Node fieldNode=investigationRuleVO.getStaticDoc().selectSingleNode("/Consultation/Fields");
	                String strPreAppYN=("Y".equals(fieldNode.valueOf("@pre-appr-yn"))?"YES":"NO");
	                
	        		 out.print("<td style='width:2%;' align='center'>"+(row+1)+"&nbsp;<a href=\"#\" onclick=\"editConsultConf('"+row+"');\">Edit</a></td>");
                    ...
                    String strEmirateHiddenBox="<input type=\"hidden\" id=\"emiratesID"+row+"\" value=\""+investigationRuleVO.getEmiratesIDs()+"\">";
	                 ...
	                 out.print("<td style='width:5%;' align='center'>"+fieldNode.valueOf("@follow-period")+"("+strfpt+")</td>");
	               
	                 out.print("<td style='width:5%;' align='center'><a href=\"#\" onclick=\"viewConsStaticConfDtls('"+row+"','CPD');\">View</a></td>");
	                 
	                
                   String strClincnsHiddenBox="<input type=\"hidden\" id=\"clinicianCopayDetailsID"+row+"\" value=\""+investigationRuleVO.getClinicianCopayDetails()+"\">";
	                 
	                 out.print("<td style='width:5%;' align='center'><a href=\"#\" onclick=\"confClinicianTypeCopay('','clinicianCopayDetailsID"+row+"','V');\">View</a>"+strClincnsHiddenBox+"</td>");
	                 ...
	                 out.print("<td style='width:3%;' align='center'><a href=\"#\" onclick=\"deleteConsDtls('"+row+"');\">"+delImage+"</a></td>");
	                 row++; 
	        	}
