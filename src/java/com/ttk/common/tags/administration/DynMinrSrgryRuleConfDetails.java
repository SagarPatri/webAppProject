...
public class DynMinrSrgryRuleConfDetails extends TagSupport{
	...
	public int doStartTag() throws JspException
	{
		try
		{
			...
			ArrayList<InvestigationRuleVO> alInvestRules=(ArrayList<InvestigationRuleVO>)session.getAttribute("MinrSrgryRuleDetails");
		...
		if(alInvestRules!=null){
	        	for(InvestigationRuleVO investigationRuleVO:alInvestRules){
	        		   ...
	        		   Node fieldNode=investigationRuleVO.getStaticDoc().selectSingleNode("/Minor-Surgeries/Fields");
	                String strPreAppYN=("Y".equals(fieldNode.valueOf("@pre-appr-yn"))?"YES":"NO");
	                
	        		 out.print("<td style='width:2%;' align='center'>"+(row+1)+"&nbsp;<a href=\"#\" onclick=\"editMinrSrgryConf('"+row+"');\">Edit</a></td>");
	                 ...
	                 out.print("<td style='width:5%;' align='center'><a href=\"#\" onclick=\"viewMinrSrgryStaticConfDtls('"+row+"','CPD');\">View</a></td>");
	                 ...
	                 out.print("<td style='width:3%;' align='center'><a href=\"#\" onclick=\"deleteMinrSrgryDtls('"+row+"');\">"+delImage+"</a></td>");
	                 row++; 
	        	}
