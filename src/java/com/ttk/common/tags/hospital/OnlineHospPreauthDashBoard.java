	...
	public int doStartTag() throws JspException{
		...
		{			
			...
			docPreauth= (((Document)pageContext.getSession().getAttribute("onlinehosphomepreauth"))!=null) 
						...
						: (Document)onlineAccessManagerObject.getHospitalDashBoard(userSecurityProfile.getHospSeqId(),null,null,"Preauth");
	                 ...
	                 out.print("<tr>");		        
			            out.print("<td width=\"100%\" align=\"left\" >");
			            	out.print("<B>");
			            	    out.print("<legend>");
			            	    out.print("&nbsp;&nbsp;");
			            		  out.print("PreAuth Details From ");out.print(preauthsNode.valueOf("@startdate"));out.print(" to "); out.print(preauthsNode.valueOf("@enddate"));//
			            		out.print("</legend>");
			            	out.print("</B>");
			            out.print("</td>");
			         out.print("</tr>");
...
*/	         				/*out.print("<a href=\"#\" onclick=\"javascript:onDashBoardPreAuths('INP')\">");*/
	         			...
	         			out.print("</td>");
	         			out.print("<td width=\"50%\" class=\"textLabelBold\" align=\"left\">");
	         				out.print((preauthsNode.valueOf("@progress").equalsIgnoreCase(""))?0:preauthsNode.valueOf("@progress"));
	         				out.print("</td>");
	         		out.print("</tr>");
