...
public class PreAuthHistoryDetails2 extends TagSupport
{
	private String flow;
	/**
	...
	*/
	...
	public int doStartTag() throws JspException{
		...
		try
		{
	      ...
	      // new added :  start
	       			    out.print("<tr>");
	       			    out.print("<td class='formLabel' width='25%'>Members Date of Inception:</td>");
	       			    out.print("<td class='textLabel' width='25%'>"+pNode.valueOf("@inception_date")+"</td>");	
	       			    out.print("<td class='formLabel' width='25%'>Members Date of Exit:</td>");
	       			    out.print("<td class='textLabel' width='25%'>"+pNode.valueOf("@exit_date")+"</td>");		   
	       			    out.print("</tr>");	
	       			    
	       			    out.print("<tr>");
	       			    out.print("<td class='formLabel' width='25%'>Providers Regulatory Authority:</td>");
	       			    out.print("<td class='textLabel' width='25%'>"+pNode.valueOf("@authority")+"</td>");	
	       			    out.print("<td class='formLabel' width='25%'>Policy Number:</td>");
	       			    out.print("<td class='textLabel' width='25%'>"+pNode.valueOf("@policy_number")+"</td>");		   
	       			    out.print("</tr>");	
	       			    
	       			    out.print("<tr>");
	       			    out.print("<td class='formLabel' width='25%'>Corporate Group Name:</td>");
	       			    out.print("<td class='textLabel' width='25%'>"+pNode.valueOf("@group_name")+"</td>");	
	       			    out.print("<td class='formLabel' width='25%'></td>");
	       			    out.print("<td class='textLabel' width='25%'></td>");		   
	       			    out.print("</tr>");
	       // new added :  end
			...
			out.print("<th align='center' class='gridHeader' title='Activity Code Type'>Act Code Type</th>");		// new added
			...
			out.print("<th align='center' class='gridHeader' title='Unit Price'>Unit Price</th>");					// new added
			...
			String addImage2="<img src='/ttk/images/rsz_observation_red_pencil.jpg' alt='Add Observ Details' width='16' height='16' border='0' align='absmiddle'>";
	       	if(aNodes!=null){				
	       			...
	       			out.print("<td align='center'>"+aNode.valueOf("@act_type")+"</td>");	// new added
	       			...
	       			out.print("<td align='center'>"+aNode.valueOf("@unit_price")+"</td>");		// new added
				  ...
				  String rmrks=(remarks.length()>6)?remarks.substring(0, 5)+"...":remarks;
	       		  ...
	       		  String obsYN=aNode.valueOf("@obs_yn");
	       	
	       		  if("Y".equals(obsYN))
	       			out.print("<td align='center'><a href='#' accesskey='o'  onClick=\"javascript:viewObservs('"+aNode.valueOf("@actdtlseqid")+"','"+pNode.valueOf("@source")+"');\">"+addImage2+"</a></td>");
	       		  else
	       		  out.print("<td align='center'><a href='#' accesskey='o'  onClick=\"javascript:viewObservs('"+aNode.valueOf("@actdtlseqid")+"','"+pNode.valueOf("@source")+"');\">"+addImage+"</a></td>");
