...
<html:form action="/ClaimActivityDetailsAction.do">
...
function displayBenefitsBasedOnType(){
	...
	document.forms[1].action="/ClaimActivityDetailsAction.do?benefitType="+benefitType;	 
	document.forms[1].submit();
}
		...
		<fieldset>
		  ...
		  <tr>
		        <td class="formLabel">Member ID:</td> 
					  <td class="textLabel">
							 <html:text  name="frmClaimGeneral" styleClass="textBox textBoxLarge textBoxDisabled"  property="memberId" />
			         
					  </td>
					  <td class="formLabel">Member InsceptionDate:</td>
					  <td class="textLabel">
					  	  <html:text  name="frmClaimGeneral" styleClass="textBox textBoxLarge textBoxDisabled" property="clmMemInceptionDate" />
					  </td>
					  </tr>
					  <tr>
					  <td class="formLabel">Policy No:</td>
					  <td class="textLabel">
				 <html:text styleClass="textBox textBoxLarge textBoxDisabled" name="frmClaimGeneral" property="policyNumber" />
						  </td>
					  <td class="formLabel">Policy End Date:</td>
					  <td class="textLabel">
					  	 <html:text styleClass="textBox textBoxLarge textBoxDisabled" name="frmClaimGeneral" property="policyEndDate" />
					  </td>
					  </tr>
					  <tr>
					  <td class="formLabel">Policy start Date: </td>
					  <td class="textLabel">
			           <html:text styleClass="textBox textBoxLarge textBoxDisabled" name="frmClaimGeneral"  property="policyStartDate" />
					  </td>
		  ...
		  <tr>
		        <td class="formLabel">Sum Insured: </td>
					  <td class="textLabel">
					 <html:text styleClass="textBox textBoxLarge textBoxDisabled"  name="frmClaimGeneral" property="sumInsured" />
			        
					  </td>
					  <td class="formLabel">Available Sum Insured: </td>
					  <td class="textLabel">
					  	 <html:text styleClass="textBox textBoxLarge textBoxDisabled" name="frmClaimGeneral" property="availableSumInsured"/>
					 </td>
		 </tr>
		 <tr>
			...
			<td class="textLabel">
				<html:text styleClass="textBox textBoxLarge textBoxDisabled"  name="frmClaimGeneral" property="utilizeSuminsured" value="${utilizeSuminsured}"/>
			</td>
		 </tr>
...
<html:hidden styleId="mode" property="mode" name="frmClaimGeneral"/>
<html:hidden name="frmClaimGeneral" property="reforward" value=""/>
</form>  
</body>
