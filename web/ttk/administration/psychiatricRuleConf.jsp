...
<html>
<%/**
 * @ (#) psychiatricRuleConf.jsp May 24th 2018
 * Project       :Vidal Health TPA Services
 * File          : psychiatricRuleConf.jsp
 * Author        : Hare Govind
...
<script type="text/javascript" src="/ttk/scripts/administration/psychiatricRuleConf.js"></script>
...
<div class="contentAreaHScroll" id="contentArea" style="">
	<html:form action="/DynPsychiatricAddRuleAction.do" >
	<!-- S T A R T : Page Title -->
	<!-- S T A R T : Page Title -->
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td >Configure Psychiatric</td>
	...
	<legend>Configuration</legend>
	   ...
	   <td width="20%" class="formLabel">Claim Type: <span class="mandatorySymbol">*</span></td>
         ...
         <td width="30%">
           <html:select name="frmDynPsychiatricRulesConfig" property="claimType"  styleClass="selectBox selectBoxMedium"  onchange="onChangeClaimTypePsychiatric();"> 
    ...
    <td width="30%">
        <html:select name="frmDynPsychiatricRulesConfig" property="networkYN" styleClass="selectBox selectBoxMedium">
...
<td width="20%" class="formLabel">Benefit Type:<span class="mandatorySymbol">*</span><br>(Encounter Type) </td>  
    	...
    	<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynPsychiatricRulesConfig" styleId="encounterTypesID"	property="encounterTypes" styleClass="textBox textBoxSmall" /></td>
			<td>
         ...
         <tr>
			...
			<html:select name="frmDynPsychiatricRulesConfig"	property="preApprvReqYN" onchange="javascript:document.getElementById('preApprvLimitID').value='';" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPsychiatricRulesConfig" styleId="preApprvLimitID"	property="preApprvLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>	
				<td class="formLabel tdClass" nowrap>Geographical Location<span class="mandatorySymbol">*</span>:</td>
			<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynPsychiatricRulesConfig" readonly="true" styleId="geoLocationID"	property="geoLocationID" styleClass="textBox textBoxSmall" /></td>
			<td>
		...
		<tr>
			...
			<table>
			<tr>
			<td><html:text name="frmDynPsychiatricRulesConfig" styleId="countryID"	property="countryIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<table>
			<tr>
			<td><html:text name="frmDynPsychiatricRulesConfig" styleId="emiratesID"	property="emiratesIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
    ...
    <html:select name="frmDynPsychiatricRulesConfig" property="providerTypes"  styleClass="selectBox selectBoxMedium">
            <html:option value="" >Select from list</html:option>
		...
		<tr>
			...
			<table>
			<tr>
			<td><html:text name="frmDynPsychiatricRulesConfig" readonly="true" styleId="providerTypesID"	property="providerTypesID" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPsychiatricRulesConfig"	property="perPolicyLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>
			
				<td class="formLabel tdClass" nowrap>Per Claim Limit:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPsychiatricRulesConfig"	property="perClaimLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>
		...
		<td class="formLabel tdClass" nowrap>Coapy(or)Deductible:</td>
			...
			<tr>
			<td nowrap>
			<html:text name="frmDynPsychiatricRulesConfig"	property="ovrCopay" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />%
			</td>			
			<td nowrap>
			(or)<html:text name="frmDynPsychiatricRulesConfig"	property="ovrDeductible" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>
			<td>
			<html:select name="frmDynPsychiatricRulesConfig"	property="ovrMinMaxFlag" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
							<html:option value="MIN">MIN</html:option>
							<html:option value="MAX">MAX</html:option>	
			</html:select>
			</td>
			<td nowrap>
			of<html:select name="frmDynPsychiatricRulesConfig"	property="ovrApplOn" style="height:20px;" 	styleClass="selectBox selectBoxSmall">
		...
		<td>
		<html:text name="frmDynPsychiatricRulesConfig"	property="perClaimCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
		</td>
			<td class="formLabel tdClass" nowrap>
		Per-policy copay/Deductible limit:
		</td>
		<td>
		<html:text name="frmDynPsychiatricRulesConfig"	property="perPolicyCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
		</td>
		</tr>
	  ...
	  <tr>
	    ...
	    <logic:notEqual value="V" name="OPConfType" scope="session">
				<button type="button" id="addPsychiatricDtlsBtnID" name="Button1" accesskey="s" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:addPsychiatricDtls();"><u>A</u>dd</button>&nbsp;
		    </logic:notEqual>	
	...
	<br>
		 	<ttk:DynPsychiatricRuleConfDetails/> 
		   <!-- S T A R T : Buttons -->
