...
<script type="text/javascript" src="/ttk/scripts/administration/pharmaruleconf.js"></script>
...
<div class="contentAreaHScroll" id="contentArea" style="">
	<html:form action="/DynPharmaAddRuleAction.do" >
	...
	<legend>Rule Date</legend>
      ...
      <tr style="margin-top: 10px;margin-left: 10px;">
         <td class="formLabel tdClass" nowrap>Provider Facility Type<span class="mandatorySymbol">*</span>:</td>
			...
			<table>
			<tr>
			<td><html:text name="frmDynPharmaRulesConfig" readonly="true" styleId="providerTypesID"	property="providerTypes" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<html:select name="frmDynPharmaRulesConfig"	property="preApprvReqYN" onchange="javascript:document.getElementById('preApprvLimitID').value='';" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
         ...
         <tr>
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPharmaRulesConfig" styleId="preApprvLimitID"	property="preApprvLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>	
			<td class="formLabel tdClass" nowrap>Per-policy Limit:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPharmaRulesConfig"	property="perPolicyLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>		
		</tr>
		...
		<tr>
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPharmaRulesConfig"	property="perClaimLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>
		...
		<td class="formLabel tdClass" nowrap>Coapy(or)Deductible Per Session:</td>
			...
			<tr>
			<td nowrap>
			<html:text name="frmDynPharmaRulesConfig"	property="ovrCopay" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />%
			</td>			
			<td nowrap>
			(or)<html:text name="frmDynPharmaRulesConfig"	property="ovrDeductible" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>
			<td>
			<html:select name="frmDynPharmaRulesConfig"	property="ovrMinMaxFlag" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
							<html:option value="MIN">MIN</html:option>
							<html:option value="MAX">MAX</html:option>	
			</html:select>
			</td>
			<td nowrap>
			of<html:select name="frmDynPharmaRulesConfig"	property="ovrApplOn" style="height:20px;" 	styleClass="selectBox selectBoxSmall">
		...
		<tr>
		<td class="formLabel tdClass" nowrap>
		 Copay/Deductible Per-Claim Limit:
		</td>
		<td>
		<html:text name="frmDynPharmaRulesConfig"	property="perClaimCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
		</td>
		<td class="formLabel tdClass" nowrap>
		 Copay/Deductible Per-Policy Limit:
		</td>
		<td>
		<html:text name="frmDynPharmaRulesConfig"	property="perPolicyCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
		</td>
	  ...
	  <tr>
	    ...
	    <logic:notEqual value="V" name="OPConfType" scope="session">
				<button type="button" id="addPharmaDtlsBtnID" name="Button1" accesskey="s" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:addPharmaDtls();"><u>A</u>dd</button>&nbsp;
		    </logic:notEqual>	
