...
<html>
<%/**
 * @ (#) gyncolgyRuleConf.jsp May 24th 2018
 * Project       :Vidal Health TPA Services
 * File          : gyncolgyRuleConf.jsp
 * Author        : Hare Govind
...
<script type="text/javascript" src="/ttk/scripts/administration/gyncolgyRuleConf.js"></script>
...
<div class="contentAreaHScroll" id="contentArea" style="">
	<html:form action="/DynGyncolgyAddRuleAction.do" >
	<!-- S T A R T : Page Title -->
	<!-- S T A R T : Page Title -->
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td >Configure Gynaecology</td>
	...
	<legend>Configuration</legend>
	   ...
	   <td width="20%" class="formLabel">Claim Type: <span class="mandatorySymbol">*</span></td>
         ...
         <td width="30%">
           <html:select name="frmDynGyncolgyRulesConfig" property="claimType"  styleClass="selectBox selectBoxMedium"  onchange="onChangeClaimTypeGyncolgy();"> 
    ...
    <td width="30%">
        <html:select name="frmDynGyncolgyRulesConfig" property="networkYN" styleClass="selectBox selectBoxMedium">
...
<td width="20%" class="formLabel">Benefit Type:<span class="mandatorySymbol">*</span><br>(Encounter Type) </td>  
    	...
    	<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynGyncolgyRulesConfig" styleId="encounterTypesID"	property="encounterTypes" styleClass="textBox textBoxSmall" /></td>
			<td>
         ...
         <tr>
			...
			<html:select name="frmDynGyncolgyRulesConfig"	property="preApprvReqYN" onchange="javascript:document.getElementById('preApprvLimitID').value='';" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynGyncolgyRulesConfig" styleId="preApprvLimitID"	property="preApprvLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>	
				<td class="formLabel tdClass" nowrap>Geographical Location<span class="mandatorySymbol">*</span>:</td>
			<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynGyncolgyRulesConfig" readonly="true" styleId="geoLocationID"	property="geoLocationID" styleClass="textBox textBoxSmall" /></td>
			<td>
		...
		<tr>
			...
			<table>
			<tr>
			<td><html:text name="frmDynGyncolgyRulesConfig" styleId="countryID"	property="countryIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<table>
			<tr>
			<td><html:text name="frmDynGyncolgyRulesConfig" styleId="emiratesID"	property="emiratesIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
    ...
    <html:select name="frmDynGyncolgyRulesConfig" property="providerTypes"  styleClass="selectBox selectBoxMedium">
            <html:option value="" >Select from list</html:option>
		...
		<tr>
			...
			<table>
			<tr>
			<td><html:text name="frmDynGyncolgyRulesConfig" readonly="true" styleId="providerTypesID"	property="providerTypesID" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynGyncolgyRulesConfig"	property="perPolicyLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>
			
				<td class="formLabel tdClass" nowrap>Per Claim Limit:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynGyncolgyRulesConfig"	property="perClaimLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>
			</tr>
		...
		<td class="formLabel tdClass" nowrap>Coapy(or)Deductible:</td>
			...
			<tr>
			<td nowrap>
			<html:text name="frmDynGyncolgyRulesConfig"	property="ovrCopay" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />%
			</td>			
			<td nowrap>
			(or)<html:text name="frmDynGyncolgyRulesConfig"	property="ovrDeductible" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>
			<td>
			<html:select name="frmDynGyncolgyRulesConfig"	property="ovrMinMaxFlag" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
							<html:option value="MIN">MIN</html:option>
							<html:option value="MAX">MAX</html:option>	
			</html:select>
			</td>
			<td nowrap>
			of<html:select name="frmDynGyncolgyRulesConfig"	property="ovrApplOn" style="height:20px;" 	styleClass="selectBox selectBoxSmall">
		...
		<td>
		<html:text name="frmDynGyncolgyRulesConfig"	property="perClaimCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
		</td>
			<td class="formLabel tdClass" nowrap>
		Per-policy copay/Deductible limit:
		</td>
		<td>
		<html:text name="frmDynGyncolgyRulesConfig"	property="perPolicyCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
		</td>
		</tr>
	  ...
	  <tr>
	    ...
	    <logic:notEqual value="V" name="OPConfType" scope="session">
				<button type="button" id="addGyncolgyDtlsBtnID" name="Button1" accesskey="s" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:addGyncolgyDtls();"><u>A</u>dd</button>&nbsp;
		    </logic:notEqual>	
	...
	<br>
		 	<ttk:DynGyncolgyRuleConfDetails/> 
		   <!-- S T A R T : Buttons -->
