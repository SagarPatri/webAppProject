...
<html>
<%/**
 * @ (#) ambulanceruleconf.jsp June 28th 2018
 * Project       :Vidal Health TPA Services
 * File          : ambulanceruleconf.jsp
 * Author        : Nagababu K
...
<script type="text/javascript" src="/ttk/scripts/administration/ambulanceRuleConfig.js"></script>
...
<div class="contentAreaHScroll" id="contentArea" style="">
	<html:form action="/DynAmbulanceAddRuleAction.do" >
	...
	<legend>Rule Date</legend>
		<table style="margin-left: 15px;width: 75%;border: 1px solid gray;" align="center" class="formContainer" cellpadding="0" cellspacing="0" border="0" width="80%">
         <tr style="margin-top: 10px;margin-left: 10px;">
			...
			<html:select name="frmDynAmbulanceRulesConfig"	property="preApprvReqYN" onchange="javascript:document.getElementById('preApprvLimitID').value='';" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
			...
			<html:text name="frmDynAmbulanceRulesConfig" styleId="preApprvLimitID"	property="preApprvLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />
			</td>
			<td class="formLabel tdClass" nowrap>Provider Facility Types<span class="mandatorySymbol">*</span>:</td>
			<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynAmbulanceRulesConfig" readonly="true" styleId="providerTypesID"	property="providerTypes" styleClass="textBox textBoxSmall" /></td>
			<td>
		...
		<td class="formLabel tdClass" nowrap>Geographical Location<span class="mandatorySymbol">*</span>:</td>
			...
			<table>
			<tr>
			<td><html:text name="frmDynAmbulanceRulesConfig" readonly="true" styleId="geoLocationID"	property="geoLocationID" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<table>
			<tr>
			<td><html:text name="frmDynAmbulanceRulesConfig" styleId="countryID"	property="countryIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<table>
			<tr>
			<td><html:text name="frmDynAmbulanceRulesConfig" styleId="emiratesID"	property="emiratesIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
    ...
    <html:select name="frmDynAmbulanceRulesConfig" property="hospType"  styleClass="selectBox selectBoxMedium">
           ...
           <html:option value="SGO|SPR" >ALL</html:option>
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynAmbulanceRulesConfig"	property="perPolicyLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />
			</td>
			<td class="formLabel tdClass" nowrap>Per-claim Limit:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynAmbulanceRulesConfig"	property="perClaimLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />
			</td>
			
		</tr>
		<tr>
		<td width="20%">Encounter Type:</td><span class="mandatorySymbol">*</span>
    <td width="30%">
    <logic:equal name="frmDynAmbulanceRulesConfig" property="benefitID" value="IPT">
    <html:select name="frmDynAmbulanceRulesConfig" property="encounterTypes"  styleClass="selectBox selectBoxMedium">
            <html:option value="" >Select from list</html:option>
           <html:option value="4" >Emergency</html:option>
           <html:option value="3" >NON-Emergency</html:option>
           <html:option value="4|3" >ALL</html:option>
            </html:select>
            </logic:equal>
              <logic:equal name="frmDynAmbulanceRulesConfig" property="benefitID" value="DAYC">
    <html:select name="frmDynAmbulanceRulesConfig" property="encounterTypes"  styleClass="selectBox selectBoxMedium">
            <html:option value="" >Select from list</html:option>
           <html:option value="6" >Emergency</html:option>
           <html:option value="5" >NON-Emergency</html:option>
           <html:option value="6|5" >ALL</html:option>
            </html:select>
            </logic:equal>
    </td>
    	<td class="formLabel tdClass" nowrap>Coapy(or)Deductible:</td>
			...
			<tr>
			<td nowrap>
			<html:text name="frmDynAmbulanceRulesConfig"	property="ovrCopay" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />%
			</td>			
			<td nowrap>
			(or)<html:text name="frmDynAmbulanceRulesConfig"	property="ovrDeductible" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>
			<td>
			<html:select name="frmDynAmbulanceRulesConfig"	property="ovrMinMaxFlag" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
							<html:option value="MIN">MIN</html:option>
							<html:option value="MAX">MAX</html:option>	
			</html:select>
			</td>
			<td nowrap>
			of<html:select name="frmDynAmbulanceRulesConfig"	property="ovrApplOn" style="height:20px;" 	styleClass="selectBox selectBoxSmall">
		...
		<td>
		<html:text name="frmDynAmbulanceRulesConfig"	property="perPolicyCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
		</td>
		<td class="formLabel tdClass" nowrap>
		Per-claim copay/Deductible limit:
		</td>
		<td>
		<html:text name="frmDynAmbulanceRulesConfig"	property="perClaimCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
		</td>
	  ...
	  <tr>
	    ...
	    <logic:notEqual value="V" name="OPConfType" scope="session">
				<button type="button" id="addConsDtlsBtnID" name="Button1" accesskey="s" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:addAmbulanceDtls();"><u>A</u>dd</button>&nbsp;
		</logic:notEqual>
	...
	<br>
			<ttk:DynAmbulanceRuleConfDetails/>
		   <!-- S T A R T : Buttons -->
