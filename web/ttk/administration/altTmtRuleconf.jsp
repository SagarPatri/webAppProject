...
<html>
<%/**
 * @ (#) vaccinruleconf.jsp May 21th 2018
 * Project       :Vidal Health TPA Services
 * File          : vaccinationRuleConfig.jsp
 * Author        : Hare Govind
 * Company       : Span Systems Corporation
 * Date Created  : May 21th 2018
 * @author       : Hare Govind
 * Modified by   :
 * Modified date :
 * Reason        :
...
<script type="text/javascript" src="/ttk/scripts/administration/altTmtRuleConf.js"></script>
...
<div class="contentAreaHScroll" id="contentArea" style="">
	<html:form action="/DynVaccinAddRuleAction.do" >
	<!-- S T A R T : Page Title -->
	<!-- S T A R T : Page Title -->
	<table align="center" class="pageTitle" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td >Configure Alternate Treatments</td>
	...
	<legend>Configuration</legend>
	   ...
	   <td width="20%" class="formLabel">Claim Type: <span class="mandatorySymbol">*</span></td>
         ...
         <td width="30%">
           <html:select name="frmDynAltTmtRulesConfig" property="claimType"  styleClass="selectBox selectBoxMedium"  onchange="onChangeClaimType();"> 
    ...
    <td width="30%">
        <html:select name="frmDynAltTmtRulesConfig" property="networkYN" styleClass="selectBox selectBoxMedium">
...
<td width="20%" class="formLabel">Benefit Type:<span class="mandatorySymbol">*</span><br>(Encounter Type) </td>  
    	...
    	<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynAltTmtRulesConfig" styleId="encounterTypesID"	property="encounterTypes" styleClass="textBox textBoxSmall" /></td>
			<td>
         ...
         <tr>
			...
			<html:select name="frmDynAltTmtRulesConfig"	property="preApprvReqYN" onchange="javascript:document.getElementById('preApprvLimitID').value='';" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynAltTmtRulesConfig" styleId="preApprvLimitID"	property="preApprvLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>	
				<td class="formLabel tdClass" nowrap>Geographical Location<span class="mandatorySymbol">*</span>:</td>
			<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynAltTmtRulesConfig" readonly="true" styleId="geoLocationID"	property="geoLocationID" styleClass="textBox textBoxSmall" /></td>
			<td>
		...
		<tr>
			...
			<table>
			<tr>
			<td><html:text name="frmDynAltTmtRulesConfig" styleId="countryID"	property="countryIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<table>
			<tr>
			<td><html:text name="frmDynAltTmtRulesConfig" styleId="emiratesID"	property="emiratesIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
    ...
    <html:select name="frmDynAltTmtRulesConfig" property="providerTypes"  styleClass="selectBox selectBoxMedium">
            <html:option value="" >Select from list</html:option>
		...
		<tr>
			...
			<table>
			<tr>
			<td><html:text name="frmDynAltTmtRulesConfig" readonly="true" styleId="providerTypesID"	property="providerTypesID" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<img	src="/ttk/images/EditIcon.gif" alt="Select Provider Type" width="16" height="16" border="0" align="absmiddle">
			  ...
			  <td width="20%" class="formLabel">Alternate Treatment Types: <span class="mandatorySymbol">*</span></td>
    	<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynAltTmtRulesConfig" readonly="true" styleId="altTmtTypesID"	property="altTmtTypes" styleClass="textBox textBoxSmall" /></td>
			<td>
			<a style="margin-left: -4px;"  href="#" accesskey="g" onClick="javascript:selectAltTmtTypes('altTmtTypesID','S')" class="search"> 
			<img	src="/ttk/images/EditIcon.gif" alt="Select Alternate Treatment Type" width="16" height="16" border="0" align="absmiddle">
			</a>
			</td>
			</tr>
			</table>		
				...
				<td class="formLabel tdClass" nowrap>Limit Per policy:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynAltTmtRulesConfig"	property="perPolicyLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>
			</tr>
			<tr>
				<td class="formLabel tdClass" nowrap>No Of Sessions Allowed:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynAltTmtRulesConfig"	property="noOfSessAllowPerPolicy" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />
			</td>	
			
            
				<td class="formLabel tdClass" nowrap>Limit Per Session:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynAltTmtRulesConfig"	property="limitPerSession" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>	
		...
		<td class="formLabel tdClass" nowrap>Coapy(or)Deductible:</td>
			...
			<tr>
			<td nowrap>
			<html:text name="frmDynAltTmtRulesConfig"	property="ovrCopay" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />%
			</td>			
			<td nowrap>
			(or)<html:text name="frmDynAltTmtRulesConfig"	property="ovrDeductible" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>
			<td>
			<html:select name="frmDynAltTmtRulesConfig"	property="ovrMinMaxFlag" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
							<html:option value="MIN">MIN</html:option>
							<html:option value="MAX">MAX</html:option>	
			</html:select>
			</td>
			<td nowrap>
			of<html:select name="frmDynAltTmtRulesConfig"	property="ovrApplOn" style="height:20px;" 	styleClass="selectBox selectBoxSmall">
		...
		<td>
		<html:text name="frmDynAltTmtRulesConfig"	property="perClaimCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
		</td>
			<td class="formLabel tdClass" nowrap>
		Per-policy copay/Deductible limit:
		</td>
		<td>
		<html:text name="frmDynAltTmtRulesConfig"	property="perPolicyCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
		</td>
		</tr>
	  ...
	  <tr>
	    ...
	    <logic:notEqual value="V" name="OPConfType" scope="session">
				<button type="button" id="addAltTmtDtlsBtnID" name="Button1" accesskey="s" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:addAltTmtDtls();"><u>A</u>dd</button>&nbsp;
		    </logic:notEqual>	
	...
	<html:hidden name="frmDynAltTmtRulesConfig" property="investgationSeqID"/>
