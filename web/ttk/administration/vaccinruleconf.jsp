...
<script type="text/javascript" src="/ttk/scripts/administration/vaccinationRuleConfig.js"></script>
...
<div class="contentAreaHScroll" id="contentArea" style="">
	...
	<legend>Configuration</legend>
	   ...
	   <td width="20%" class="formLabel">Claim Type: <span class="mandatorySymbol">*</span></td>
         ...
         <td width="30%">
           <html:select name="frmDynVaccinRulesConfig" property="claimType"  styleClass="selectBox selectBoxMedium" onchange="doChangeClaimTypeVaccin();">  
    ...
    <td width="30%">
        <html:select name="frmDynVaccinRulesConfig" property="networkYN" styleClass="selectBox selectBoxMedium">
...
<td width="20%" class="formLabel">Benefit Type:<span class="mandatorySymbol">*</span><br>(Encounter Type) </td>  
    	...
    	<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynVaccinRulesConfig" styleId="encounterTypesID"	property="encounterTypes" styleClass="textBox textBoxSmall" /></td>
			<td>
         ...
         <tr>
			...
			<html:select name="frmDynVaccinRulesConfig"	property="preApprvReqYN" onchange="javascript:document.getElementById('preApprvLimitID').value='';" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynVaccinRulesConfig" styleId="preApprvLimitID"	property="preApprvLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>	
				<td class="formLabel tdClass" nowrap>Geographical Location<span class="mandatorySymbol">*</span>:</td>
			<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td><html:text name="frmDynVaccinRulesConfig" readonly="true" styleId="geoLocationID"	property="geoLocationID" styleClass="textBox textBoxSmall" /></td>
			<td>
		...
		<tr>
			...
			<table>
			<tr>
			<td><html:text name="frmDynVaccinRulesConfig" styleId="countryID"	property="countryIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<table>
			<tr>
			<td><html:text name="frmDynVaccinRulesConfig" styleId="emiratesID"	property="emiratesIDs" styleClass="textBox textBoxSmall" /></td>
			<td>
    ...
    <html:select name="frmDynVaccinRulesConfig" property="providerTypes"  styleClass="selectBox selectBoxMedium">
            <html:option value="" >Select from list</html:option>
		...
		<tr>
			...
			<table>
			<tr>
			<td><html:text name="frmDynVaccinRulesConfig" readonly="true" styleId="providerTypesID"	property="providerTypesID" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynVaccinRulesConfig"	property="perPolicyLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>
			
				<td class="formLabel tdClass" nowrap>Per-Claim Limit:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynVaccinRulesConfig"	property="perClaimLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>	
		...
		<td class="formLabel tdClass" nowrap>Coapy(or)Deductible:</td>
			...
			<tr>
			<td nowrap>
			<html:text name="frmDynVaccinRulesConfig"	property="ovrCopay" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />%
			</td>			
			<td nowrap>
			(or)<html:text name="frmDynVaccinRulesConfig"	property="ovrDeductible" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />AED
			</td>
			<td>
			<html:select name="frmDynVaccinRulesConfig"	property="ovrMinMaxFlag" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
							<html:option value="MIN">MIN</html:option>
							<html:option value="MAX">MAX</html:option>	
			</html:select>
			</td>
			<td nowrap>
			of<html:select name="frmDynVaccinRulesConfig"	property="ovrApplOn" style="height:20px;" 	styleClass="selectBox selectBoxSmall">
		...
		<td>
		<html:text name="frmDynVaccinRulesConfig"	property="perClaimCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
		</td>
			<td class="formLabel tdClass" nowrap>
		Per-policy copay/Deductible limit:
		</td>
		<td>
		<html:text name="frmDynVaccinRulesConfig"	property="perPolicyCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
		</td>
		</tr>
		<tr>
				<td class="formLabel tdClass" nowrap>Allowed Age:Min</td>
			<td width="30%" class="textLabel tdClass">
			<table>
			<tr>
			<td nowrap>
			<html:text name="frmDynVaccinRulesConfig"	property="minAge" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />to
			</td>			
			<td nowrap>
			Max<html:text name="frmDynVaccinRulesConfig"	property="maxAge" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />
			</td>
			<td>
			<html:select name="frmDynVaccinRulesConfig"	property="allowedAgeType" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
	  ...
	  <tr>
	    ...
	    <logic:notEqual value="V" name="OPConfType" scope="session">
				<button type="button" id="addVaccinDtlsBtnID" name="Button1" accesskey="s" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:addVaccinDtls();"><u>A</u>dd</button>&nbsp;
		    </logic:notEqual>	
