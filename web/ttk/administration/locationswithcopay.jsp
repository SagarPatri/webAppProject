...
<script type="text/javascript" src="/ttk/scripts/administration/locationswithcopay.js"></script>
...
<logic:equal value="PRO" name="frmProviderCopayRules" property="locationType">
<table align="left" style="color:#000000; border: 1px solid #000000; background-color:#EBEDF2;  margin-top:30px; margin-left: 20px;" border="0" cellspacing="0" cellpadding="0">
		<tr>
		    <td style="margin-top:10px; margin-left: 10px;" nowrap>&nbsp;&nbsp;&nbsp;Provider License ID:<br>
		    	<html:text property="providerLicenseNO" name="frmProviderCopayRules"  styleClass="textBox textBoxLarge" maxlength="60"/>
		    </td>
		    <td style="margin-top:10px; margin-left: 10px;" nowrap>&nbsp;&nbsp;Provider Name:<br>
		    <table>
		    <tr>		    
		    <td><html:text property="providerName" name="frmProviderCopayRules"  styleClass="textBox textBoxLarge" maxlength="60"/></td>
		    <td><a href="#" accesskey="s" onClick="javascript:onSearchProviders()"   class="search"><img src="/ttk/images/SearchIcon.gif" alt="Search" width="16" height="16" border="0" align="absmiddle">&nbsp;<u>S</u>earch</a></td>
		    </tr>
		    </table>
...
<div class="contentArea" id="contentArea" style="height: 350px;">
 <ttk:ProviderLocationCopayDetails/>
 </div>
...
<html:hidden name="frmProviderCopayRules" property="locationType"/>
