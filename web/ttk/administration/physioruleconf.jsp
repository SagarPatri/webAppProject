...
<html>
<%/**
 * @ (#) physioruleconf.jsp June 28th 2017
...
<script type="text/javascript" src="/ttk/scripts/administration/physioruleconf.js"></script>
	...
	<legend>Rule Date</legend>
      ...
      <tr style="margin-top: 10px;margin-left: 10px;">
         <td class="formLabel tdClass" nowrap>Provider Facility Type<span class="mandatorySymbol">*</span>:</td>
			...
			<table>
			<tr>
			<td><html:text name="frmDynPhysioRulesConfig" readonly="true" styleId="providerTypesID"	property="providerTypes" styleClass="textBox textBoxSmall" /></td>
			<td>
			...
			<html:select name="frmDynPhysioRulesConfig"	property="preApprvReqYN" onchange="javascript:document.getElementById('preApprvLimitID').value='';" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
         ...
         <tr>
			...
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPhysioRulesConfig" styleId="preApprvLimitID"	property="preApprvLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>	
			<td class="formLabel tdClass" nowrap>Per-policy Limit:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPhysioRulesConfig"	property="perPolicyLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>		
		</tr>
		...
		<tr>
			...
			<table>
			<tr><td>No. of sessions allowed:</td></tr>
			<tr><td>per policy</td></tr>
			</table>			
			</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPhysioRulesConfig"	property="noOfSessAllowPerPolicy" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />
			</td>
			<td class="formLabel tdClass" nowrap>Per-Session Limit:</td>
			<td width="30%" class="textLabel tdClass">
			<html:text name="frmDynPhysioRulesConfig"	property="limitPerSession" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>
		</tr>
		<tr>
		<td class="formLabel tdClass" nowrap>Coapy(or)Deductible Per Session:</td>
			<td width="30%" class="textLabel tdClass" colspan="3">
			<table>
			<tr>
			<td nowrap>
			<html:text name="frmDynPhysioRulesConfig"	property="ovrCopay" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />%
			</td>			
			<td nowrap>
			(or)<html:text name="frmDynPhysioRulesConfig"	property="ovrDeductible" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
			</td>
			<td>
			<html:select name="frmDynPhysioRulesConfig"	property="ovrMinMaxFlag" style="height:20px;width:50px;" 	styleClass="selectBox selectBoxSmall">
							<html:option value="MIN">MIN</html:option>
							<html:option value="MAX">MAX</html:option>	
			</html:select>
			</td>
			<td nowrap>
			of<html:select name="frmDynPhysioRulesConfig"	property="ovrApplOn" style="height:20px;" 	styleClass="selectBox selectBoxSmall">
		...
		<tr>
		<td class="formLabel tdClass" nowrap>
		 Copay/Deductible Per-Policy Limit:
		</td>
		<td>
		<html:text name="frmDynPhysioRulesConfig"	property="perPolicyCpyDdctLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
		</td>
		<td class="formLabel tdClass" nowrap>
		Copay/Deductible Per Session Limit:
		</td>
		<td>
		<html:text name="frmDynPhysioRulesConfig"	property="copayDedPerSessionLimit" onkeyup="isNumeric(this);"  styleClass="textBox textBoxTiny" />(AED)
		</td>
		</tr>
	  ...
	  <tr>
	    ...
	    <logic:notEqual value="V" name="OPConfType" scope="session">
				<button type="button" id="addPhysioDtlsBtnID" name="Button1" accesskey="s" class="buttons" onMouseout="this.className='buttons'" onMouseover="this.className='buttons buttonsHover'" onClick="javascript:addPhysioDtls();"><u>A</u>dd</button>&nbsp;
		    	</logic:notEqual>
