...
<script type="text/javascript" src="/ttk/scripts/administration/mohprovidercopaydetails.js"></script>
  ...
  <table align="center" class="formContainer" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="20%" class="formLabel">Benefit Type: <span class="mandatorySymbol">*</span></td>
         ...
         <html:select property="benefitType" name="frmMOHProviderCopayRules"  styleClass="selectBox selectBoxMedium"  disabled="true">
      ...
      <td width="20%" class="formLabel">Claim Type: <span class="mandatorySymbol">*</span></td>
         ...
         <td width="30%">
           <html:select name="frmMOHProviderCopayRules" property="claimType"  styleClass="selectBox selectBoxMedium" onchange="onChangeClaimType();">
            <html:option value="" >Select from list</html:option>
    ...
    <logic:equal name="frmMOHProviderCopayRules" property="claimType" value="CNH">
       <html:select name="frmMOHProviderCopayRules" property="networkYN" styleClass="selectBox selectBoxMedium" disabled="true" >
							  <html:option value="Y">NETWORK</html:option>
					  </html:select>
    </logic:equal>
     <logic:notEqual name="frmMOHProviderCopayRules" property="claimType" value="CNH">
    <html:select name="frmMOHProviderCopayRules" property="networkYN" styleClass="selectBox selectBoxMedium">
							 <html:option value="">Select from list</html:option>
							  <html:option value="Y">NETWORK</html:option>
...
<!-- 					  -- -->
 ...
 <td width="20%">Encounter Types:<span class="mandatorySymbol">*</span></td>
    <td width="30%">
    <table>
    <tr>
    <td> <html:text name="frmMOHProviderCopayRules" styleId="encounterTypesID"	property="encounterTypes"  styleClass="textBox textBoxMedium"	readonly="true" /></td>
    <td>
     <a href="#" accesskey="g"	onClick="javascript:doSelectEncounters('encounterTypesID','S');" class="search"> <img	src="/ttk/images/EditIcon.gif" alt=""	width="16" height="16" border="0" align="absmiddle">&nbsp;</a>
    </td>
    </tr>
    </table>
    ...
    <table>
    <tr>
    <td> <html:text name="frmMOHProviderCopayRules"	property="geoLocation" styleId="geoLocations"  styleClass="textBox textBoxMedium"	readonly="true" /></td>
    <td>
    ...
    <td width="20%">Country:<span class="mandatorySymbol">*</span></td>
    <td width="30%">
    <table>
    <tr>
    <td> <html:text name="frmMOHProviderCopayRules" styleId="countryIDs"	property="countryIDs"  styleClass="textBox textBoxMedium"	readonly="true" /></td>
    <td>
...
<tr>
 <td width="20%">Emirate:</td>
    <td width="30%">
    <table>
    <tr>
    <td> <html:text name="frmMOHProviderCopayRules" styleId="emirateIDs"	property="emirateIDs"  styleClass="textBox textBoxMedium"	readonly="true" /></td>
    <td>
     <a href="#" accesskey="g"	onClick="javascript:onSelectLocations('EMR');" class="search"> <img	src="/ttk/images/EditIcon.gif" alt=""	width="16" height="16" border="0" align="absmiddle">&nbsp;</a>
    </td>
    </tr>
    </table>
    ...
    <html:select name="frmMOHProviderCopayRules" property="providerType"  styleClass="selectBox selectBoxMedium">
            <html:option value="" >Select from list</html:option>
...
<tr>
 <td width="20%">Provider Facility Type:<span class="mandatorySymbol">*</span></td>
    ...
    <table>
    <tr>
    <td> <html:text name="frmMOHProviderCopayRules" styleId="providerFacilities"	property="providerFacilities"  styleClass="textBox textBoxMedium"	readonly="true" /></td>
    <td>
    ...
    <table>
    <tr>
    <td> <html:text name="frmMOHProviderCopayRules"	property="providerSeqIDs"  styleClass="textBox textBoxMedium"	readonly="true" /></td>
    <td>
...
<fieldset>
  <legend><bean:write name="frmMOHProviderCopayRules" property="benefitTypeDesc"/>&nbsp;Summary</legend>
 <ttk:MOHProviderCopayCondionDetails/>
 </fieldset>
...
<logic:notEmpty name="frmMOHProviderCopayRules" property="frmChanged">
