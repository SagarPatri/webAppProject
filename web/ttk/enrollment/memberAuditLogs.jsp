...
pageContext.setAttribute("userRoleList",Cache.getCacheObject("userRoleList"));
 */
...
%>
	...
	<div class="contentArea" id="contentArea">
	 ...
	 <fieldset>
	 <legend>Audit Logs for Employee - <bean:write name="frmMember" property="alRelationShip"/></legend>
	 ...
	 <td nowrap>Field Name:<br>
		    <html:select property="fieldname" name="frmMember"  styleClass="selectBox textBoxLarge">
		     <html:option value="">Any</html:option>
		     	 ...
		     	 <html:option value="REL">Relationship</html:option> 
		         <html:option value="BFN">Beneficiary First Name</html:option> 
		         <html:option value="FN">Family Name</html:option>
		         <html:option value="GEN">Gender</html:option> 
		    	 <html:option value="DOB">Date of Birth</html:option> 
		    	 <html:option value="EMI">Emirate ID Number</html:option> 
		    	 <html:option value="NAT">Nationality</html:option>  
		     	 <html:option value="MAR">Marital Status</html:option>
		         <html:option value="PASS">Passport Number</html:option> 
		         <html:option value="UID">UID Number</html:option> 
		          <html:option value="ST">Status</html:option> 
		    	 <html:option value="DOI">Date of Inception</html:option> 
		         <html:option value="COUN">Country</html:option> 
		         <html:option value="STATE">Emirate</html:option> 
		     	 <html:option value="RL">Residential Location</html:option> 
		     	 <html:option value="WL">Work Location</html:option> 
		         <html:option value="EMAIL">Email Id1</html:option> 
		         <html:option value="PH">Contact Number</html:option> 
		         <html:option value="MP">Medical Premium</html:option> 
		         <html:option value="IM">Insurer Margin</html:option> 
		         <html:option value="BR">Broker Margin</html:option> 
		         <html:option value="GP">Gross Premium</html:option> 
		         <html:option value="INP">IP Net Premium</html:option>  
		   	     <html:option value="AP">Pro-rata Premium (Actual Premium)</html:option>  	
		         <html:option value="ONP">OP Net Premium</html:option> 	
		    	
		    
		    <%-- 
		         <html:option value="ST">Status</html:option> 
		     	 <html:option value="END">ENDOSMENT_SEQ_ID</html:option> 
		    	 <html:option value="MEM">MEMEBER_SEQ_ID</html:option> 
		    	 <html:option value="OG">OLD_GENDER</html:option> 
		    	 <html:option value="OR">OLD_RELATIONSHIP</html:option> 
		    	 <html:option value="PGI">POLICY_GROUP_SEQ_ID</html:option> 
		    	 <html:option value="CT">CITY_TYPE_ID</html:option>  
		    	 <html:option value="SB">SALARY_BAND</html:option> 
		    	 <html:option value="AN">AMIL_NAME</html:option> 
		    	 <html:option value="EMP">EMPLOYEE_NO</html:option> 
		         <html:option value="OPH">OFF_PHONE_NO_1</html:option> 
		    	 <html:option value="PRI">PRINICIPLE_NAME</html:option>  
		    	 
		    	  <html:option value="BC">Birth City</html:option> 
		    	 --%>
