...
function displayBenefitsBasedOnType(){
	...
	document.forms[1].action="/PolicyBenefitsAction.do?benefitType1="+benefitType1;	
	document.forms[1].submit();
}
		...
		<fieldset>
		  ...
		  <tr>
		        <td class="formLabel">Member ID:</td> 
					  <td class="textLabel">
					 <html:text styleClass="textBox textBoxLarge textBoxDisabled"  value="${memberId}" property ="memberId" />
			         
					  </td>
					  <td class="formLabel">Member InsceptionDate:</td>
					  <td class="textLabel">
					  	  <html:text styleClass="textBox textBoxLarge textBoxDisabled" name="frmEnrollBenefits" value="${MemberInceptionDate}" property="preMemInceptionDt"/>
					  </td>
					  </tr>
					  <tr>
					  <td class="formLabel">Policy No:</td>
					  <td class="textLabel">
				 <html:text styleClass="textBox textBoxLarge textBoxDisabled" name="frmEnrollBenefits" value="${PolicyNo}" property="policyNumber"/>
					  </td>
					  <td class="formLabel">Policy End Date:</td>
					  <td class="textLabel">
					  	 <html:text  styleClass="textBox textBoxLarge textBoxDisabled" name="frmEnrollBenefits" value="${PolicyEndDate}" property="policyEndDate"/>
					  </td>
					  </tr>
					  <tr>
					  <td class="formLabel">Policy start Date: </td>
					  <td class="textLabel">
			          <html:text  styleClass="textBox textBoxLarge textBoxDisabled" name="frmEnrollBenefits" value="${PolicyStartDate}" property="policyStartDate"/>
					  </td>
		  ...
		  <tr>
		        <td class="formLabel">Sum Insured:</td>
					  <td class="textLabel">
					  <html:text styleClass="textBox textBoxLarge textBoxDisabled" name="frmEnrollBenefits" value="${SumInsured}" property="sumInsured"/>
			         
					  </td>
					  <td class="formLabel">Available Sum Insured:</td>
					  <td class="textLabel">
					  	    <html:text styleClass="textBox textBoxLarge textBoxDisabled" name="frmEnrollBenefits" value="${availableSumInsured}" property="availableSumInsured"/>
					  </td>
		 </tr>
		  ...
		  <tr>
		 	...
		 	<td class="textLabel">
		 	<html:select onchange="displayBenefitsBasedOnType()"  name="frmEnrollBenefits" property="benefitType" styleId="benefitType" styleClass="selectBox selectBoxMedium"  >
			...
			<td class="textLabel">
				<html:text styleClass="textBox textBoxLarge textBoxDisabled"  name="frmEnrollBenefits" value="${utilizeSuminsured}" property="utilizeSuminsured"/>
			</td>
		 </tr>
...
<td class=generalcontent colSpan=16 align=left>&nbsp;&nbsp;${otherRemarks}</td>
 ...
 <html:hidden styleId="mode" name="frmEnrollBenefits" property="mode"/> 
<html:hidden property="reforward" value=""/>
</form>  
</body>
