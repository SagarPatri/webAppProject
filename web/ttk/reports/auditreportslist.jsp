...
<!--      <li class="liPad"><a href="#" onClick="javascript:onSelectEnrolMonitor()">Enrollment Monitor</a></li>
    ...
    <li class="liPad"><a href="#" onClick="javascript:onAuditTrial()">Audit Trail</a></li>
    <li class="liPad"><a href="#" onClick="javascript:onAuditResultUpload()">Audit Result Upload</a></li>
   <!--  <li class="liPad"><a href="#" onClick="javascript:onEnReport()">Audit Result Upload</a></li> -->
    </ul>
    </td>
    </tr>
    </table>
