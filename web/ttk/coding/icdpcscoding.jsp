	...
	<div class="contentArea" id="contentArea">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="formContainer" style="padding:0px;margin:0px;">
          ...
          <tr>
            ...
            <td width="3%" align="center" ><a href="#" class="search" ><img src="/ttk/images/AddIcon.gif" alt="ICDCode" width="16" height="16" border="0" onClick="javascript:getNewICDCode()"></a></td>
