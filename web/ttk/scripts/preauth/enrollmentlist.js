...
//function to sort based on the link selected
	...
	{
	    var memberSeqID = document.getElementById("lngMemberSeqID").value;
	     var openPage="/ttk/customercare/loghistory.jsp?memberSeqID="+memberSeqID;
	...
	function doViewCustomerHistoryPAT(authSeqID1){
	   
	     window.opener.document.forms[1].mode.value = "doViewHistoryCustomer";
	         window.opener.document.forms[1].action = "/EnrollmentListAction.do?mode=doViewHistoryCustomer&authSeqID="+authSeqID1+"&flag="+"P"+"";
	         window.opener.document.forms[1].submit();
	         self.close();
	    }//end of doViewHistoryPAT
	function doViewCustomerHistoryCLM(authSeqID1){
	   
	   
	     window.opener.document.forms[1].mode.value = "doViewHistoryCustomer";
	         window.opener.document.forms[1].action = "/EnrollmentListAction.do?mode=doViewHistoryCustomer&authSeqID="+authSeqID1+"&flag="+"C"+"";
	         window.opener.document.forms[1].submit();
	         self.close();
	    }//end of doViewHistoryCLM
	function onBack()
	{
	...
	function onCheckbenifitType()
	{
		var memberSeqID = document.getElementById("lngMemberSeqID").value;
		
		    document.forms[1].mode.value="dobenifitType";
			document.forms[1].action = "/EnrollmentListAction.do?mode=dobenifitType&memberSeqID="+memberSeqID;
			//document.forms[1].action="/EnrollmentListAction.do";
			document.forms[1].submit();
