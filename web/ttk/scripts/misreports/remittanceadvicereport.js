...
+document.getElementById("spaymentRefChequeNumber").value+"|"+document.getElementById("sremittanceFileName").value+"|"+document.getElementById("sremittancefrmDate").value+"|"+document.getElementById("sremittancetoDate").value+"|"+"FIN"+"|";
var partmeter = "?mode=doGenerateDetailRemittanceReport&argList="+argList+"&repType=FINANCE";
