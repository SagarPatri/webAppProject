...
<script language="javascript" src="/ttk/scripts/misreports/remittanceadvicereport.js"></script>
	...
	<fieldset>
	 <legend>Report Parameters </legend>
	  <table border="0" align="center" cellpadding="0" cellspacing="0" class="searchContainer">
		...
		<a name="CalendarObjectremittancefrmDate" id="CalendarObjectremittancefrmDate" href="#" onClick="javascript:show_calendar('CalendarObjectremittancefrmDate','frmMISFinanceReports.sremittancefrmDate',document.frmMISFinanceReports.sremittancefrmDate.value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;">
		...
		<a name="CalendarObjectremittancetoDate" id="CalendarObjectremittancetoDate" href="#" onClick="javascript:show_calendar('CalendarObjectremittancetoDate','frmMISFinanceReports.sremittancetoDate',document.frmMISFinanceReports.sremittancetoDate.value,'',event,148,178);return false;" onMouseOver="window.status='Calendar';return true;" onMouseOut="window.status='';return true;">
			<img src="/ttk/images/CalendarIcon.gif" alt="Calendar" name="empDate" width="24" height="17" border="0" align="absmiddle">
		</a>
		<br>&nbsp;&nbsp;&nbsp;&nbsp;to Date
     		</td>
