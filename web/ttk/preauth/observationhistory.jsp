...
{
		var preAuthSeqID=document.forms[0].authSeqID.value; 
		var activityDtlSeqId=document.forms[0].activityDtlSeqId.value;
...
<br><br>
<html:form action="/ObservationAction.do" method="post" enctype="multipart/form-data">
  ...
  <logic:notEmpty name="observations" scope="session">  
	...
	<logic:notEqual name="preAuthRecvTypeID" scope="request" value="e-authorization">
	...
	<logic:equal  name="preAuthRecvTypeID" scope="request" value="e-authorization">
...
<INPUT TYPE="hidden" NAME="preAuthRecvTypeID" VALUE="<%=(String)request.getAttribute("preAuthRecvTypeID") %>">
<INPUT TYPE="hidden" NAME="authSeqID"  VALUE="<%=(String)request.getAttribute("authSeqID") %>">
<INPUT TYPE="hidden" NAME="activityDtlSeqId" VALUE="<%=(String)request.getAttribute("activityDtlSeqId") %>">
</html:form>
</div>	 			    
</body>
</html>