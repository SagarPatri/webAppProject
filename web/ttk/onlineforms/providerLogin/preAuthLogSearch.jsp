...
<!-- <div id="navigateBar">Home > Corporate > Detailed > Claim Details</div> -->
	...
	<h4 class="sub_heading">Pre-Auth Log Search</h4>
<html:errors/>
	<div id="contentOuterSeparator"></div>
</div>           
...
<div class="span12" style="margin:0% 0%"> 
	...
	<table align="center" class="searchContainer" border="0" cellspacing="3" cellpadding="3">
    	      ...
    	      <td width="25%" nowrap>Pre-Auth Number:<br>
    	     ...
    	     <tr>
    	        <td width="25%" nowrap>Approval Number:<br>
    	     ...
    	     <tr>
   	        ...
   	        <td width="25%" nowrap>PreAuth Ref No.:<br> 
