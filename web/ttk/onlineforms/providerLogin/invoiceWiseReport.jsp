...
<html:form action="/OnlineFinanceAction.do">
	<%
		ArrayList<String> strChequeDetails = (ArrayList<String>) request
					.getSession().getAttribute("strChequeDetails");
	%>
	<body id="pageBody">
							...
							<div style="width: 100%;">
								<div class="span12" style="margin: 0% 0%">
									...
									<table style="border-radius: 10px; width: 75%; height: auto;"
										...
										<tr>
											<td align="left">Cheque/EFT Number:</td>
											<td align="left">${strChequeDetails[16]}</td>
										</tr>
										<tr>
											<td align="left">Cheque/EFT Date :</td>
										...
										<tr>
											<td width="100%" align="center">
												<button type="button" name="Button" accesskey="d"
													class="buttons" onMouseout="this.className='buttons'"
													onMouseover="this.className='buttons buttonsHover'"
													onClick="javascript:onDownloadInvoice();">
													<u>D</u>ownload
